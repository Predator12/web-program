Кроки інсталяції та запуск веб-сайту
...
2. Потрібно створити файл server.js та налаштувати його:
    ...
    console.log('Magic happens on port ' + port); 
        ...
        ```
3. Підєднатись до MongoDB і задати шлях на ск

4. Для запуску сервера в консолі прописати $ node server.js

5. Перейти на http://localhost:8080/api